...
urlpatterns = [
    ...
    path('api/auth/password-reset-confirm/', views.PasswordResetConfirmView.as_view(), name='api_password_reset_confirm_body'),
    path('api/token/', views.CustomTokenObtainPairView.as_view(), name='token_obtain_pair'),
    path("api/perfil/", views.PerfilView.as_view(), name="perfil"),
    path('api/auth/password-reset-confirm/<str:uidb64>/<str:token>/', views.PasswordResetConfirmView.as_view(), name='api_password_reset_confirm_path'),
